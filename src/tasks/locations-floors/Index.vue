    ...
    export default {
        ...
        mounted (){
            ...
            this.$systemFunctions.loadTaskLanguages([
                {language:this.$systemVariables.language,file:'tasks/locations-floors/language.js'},
            ]);
            this.init();            
        },
        computed:{   
        ...
        methods: {
            init(){
                ...
                this.$axios.get('/locations-floors/initialize')
                .then(res=>{
            ...
            getItems(pagination){
                this.$systemVariables.statusDataLoaded=0;
                this.$axios.get('/locations-floors/get-items?page='+ pagination.current_page+'&perPage='+ pagination.per_page)
                .then(res => {
                    this.$systemVariables.statusDataLoaded = 1;
                    if(res.data.error==''){
            ...
            saveItem(){
                ...
                this.$systemVariables.statusDataLoaded=0;
                this.$axios.post('/locations-floors/save-item',new FormData(document.getElementById('formSave')))
                .then(res => {
                    this.$systemVariables.statusDataLoaded = 1;
                    if(res.data.error==''){
